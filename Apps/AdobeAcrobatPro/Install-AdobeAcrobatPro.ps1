...
#region Customisation
	...
	New-Item -Path 'HKLM:\SOFTWARE\Policies\Adobe\Adobe Acrobat\DC\FeatureLockDown\cServices' -ErrorAction SilentlyContinue
	New-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Adobe\Adobe Acrobat\DC\FeatureLockDown\cServices' -Value 0 -Name bUpdater -PropertyType DWORD -Force
	...
	New-Item -Path 'HKLM:\SOFTWARE\Policies\Adobe\Adobe Acrobat\DC\FeatureLockDown\cIPM'  -ErrorAction SilentlyContinue
	...
	New-Item -Path 'HKLM:\SOFTWARE\WOW6432Node\Policies\Adobe\Adobe Acrobat\DC\FeatureLockDown' -ErrorAction SilentlyContinue
	New-ItemProperty -Path 'HKLM:\SOFTWARE\WOW6432Node\Policies\Adobe\Adobe Acrobat\DC\FeatureLockDown'-Value 0 -Name bUpdater -PropertyType DWORD -Force
